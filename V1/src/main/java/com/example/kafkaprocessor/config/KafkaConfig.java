...
public class KafkaConfig {
    ...
    @Value("${kafka.topic.consumers-per-dc}")
    ...
    public void validateConfiguration() {
        ...
        if (listenerConcurrency != expectedConcurrency) {
            log.warn("WARNING: Listener concurrency misconfigured!");
            ...
            log.info("Kafka concurrency validated: {} threads for {} partitions with {} consumers per DC", 
    ...
    @Bean
    public String kafkaListenerConcurrency() {
